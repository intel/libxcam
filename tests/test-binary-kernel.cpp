/*
 * test-binary-kernel.cpp - test binary kernel
 *
...
int main (int argc, char *argv[])
{
    ...
    const char *source_file = NULL, *binary_file = NULL;
    ...
    kernel_name_length = strlen (source_file) - 3;
    kernel_name = (char *) malloc (sizeof (char) * kernel_name_length);

    strncpy (kernel_name, source_file, kernel_name_length);
    ...
    kernel_body = (char *) malloc (sizeof (char) * source_sizes);
