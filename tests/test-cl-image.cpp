...
int main (int argc, char *argv[])
{
    ...
    if (handler_type == TestHandlerHaarWavelet)
    {
        SmartPtr<DrmBoBufferPool> drmBoBuf_pool = buf_pool.dynamic_cast_ptr<DrmBoBufferPool> ();
        drmBoBuf_pool->set_swap_flags (SwappedBuffer::SwapY | SwappedBuffer::SwapUV, SwappedBuffer::OrderY1Y0 | SwappedBuffer::OrderUV0UV1);
    }
