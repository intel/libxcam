/*
 * sample_wrapper.cpp - smart analysis sample code
 *
...
#include <base/xcam_smart_analysis_description.h>
...
xcam_get_results (XCamSmartAnalysisContext *context, XCam3aResultHead *results[], uint32_t *res_count)
{
    ...
    result_count = translate_3a_results_to_xcam (analysis_results, res_array, XCAM_3A_LIB_MAX_RESULT_COUNT);
