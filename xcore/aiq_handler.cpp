...
AiqAeHandler::set_RGBS_weight_grid (ia_aiq_rgbs_grid **out_rgbs_grid)
{
    ...
    unsigned short rgbs_grid_width = (*out_rgbs_grid)->grid_width;
    unsigned short rgbs_grid_height = (*out_rgbs_grid)->grid_height;
...
AiqAeHandler::set_hist_weight_grid (ia_aiq_hist_weight_grid **out_weight_grid)
{
    ...
    unsigned short hist_grid_width = (*out_weight_grid)->width;
    unsigned short hist_grid_height = (*out_weight_grid)->height;
...
AiqAeHandler::dump_hist_weight_grid (const ia_aiq_hist_weight_grid *weight_grid)
{
    ...
    unsigned short grid_width = weight_grid->width;
    unsigned short grid_height = weight_grid->height;
...
AiqAeHandler::dump_RGBS_grid (const ia_aiq_rgbs_grid *rgbs_grid)
{
    ...
    unsigned short grid_width = rgbs_grid->grid_width;
    unsigned short grid_height = rgbs_grid->grid_height;
